...
export function EnAttente({ taches, onDestination, onSupprimer, onOuvrir }: {
  ...
  return (
    <aside className="flex w-[380px] flex-none flex-col border-l border-bord-faible bg-surface-3">
      <header className="flex h-16 flex-none items-center pl-6 pr-4"><h2 className="flex-1 text-[22px] font-medium tracking-tight">En attente</h2><Bascule replie={false} onClick={() => poserReplie(true)} /></header>
